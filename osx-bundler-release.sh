...
if [[ -z $1 || -z $2 ]]; then
    ...
    mkdir -p "target/release/$1.vst3/Contents/MacOS"

    # Create the PkgInfo
    echo "BNDL????" > "target/release/$1.vst3/Contents/PkgInfo"
...
<dict>
    ...
    <string>org.peerpresence.$1</string>
...
</plist>" > "target/release/$1.vst3/Contents/Info.plist"

    # move the provided library to the correct location
    cp "$2" "target/release/$1.vst3/Contents/MacOS/$1"

    echo "Created bundle target/release/$1.vst3"
fi
